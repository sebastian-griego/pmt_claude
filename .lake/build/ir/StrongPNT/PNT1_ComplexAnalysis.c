...
// Module: StrongPNT.PNT1_ComplexAnalysis
// Imports: Init Mathlib.Analysis.Complex.Basic Mathlib.Analysis.Complex.Norm Mathlib.Analysis.SpecialFunctions.Log.Basic Mathlib.Analysis.SpecialFunctions.Pow.Complex Mathlib.Analysis.SpecialFunctions.Trigonometric.Complex Mathlib.Analysis.Complex.Exponential Mathlib.Data.Complex.Basic Mathlib.Analysis.Analytic.Basic Mathlib.Analysis.Analytic.Constructions Mathlib.Analysis.Calculus.Deriv.Basic Mathlib.Analysis.Calculus.Deriv.Mul Mathlib.Analysis.Calculus.Deriv.Comp Mathlib.Analysis.Complex.RealDeriv Mathlib.MeasureTheory.Integral.IntervalIntegral.Basic Mathlib.MeasureTheory.Integral.IntervalIntegral.FundThmCalculus Mathlib.Topology.MetricSpace.Basic Mathlib.Analysis.Complex.Liouville Mathlib.Analysis.Complex.Schwarz Mathlib.Analysis.Complex.AbsMax Mathlib.Analysis.Complex.CauchyIntegral Mathlib.Data.Set.Function Mathlib.Analysis.Normed.Module.RCLike.Real
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_StrongPNT_PNT1__ComplexAnalysis(uint8_t builtin, lean_object* w) {
lean_object * res;
