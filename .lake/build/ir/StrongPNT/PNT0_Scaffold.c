...
// Imports: Init Mathlib.Data.Real.Basic Mathlib.Analysis.SpecialFunctions.Log.Basic
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_StrongPNT_PNT0__Scaffold(uint8_t builtin, lean_object* w) {
lean_object * res;
